        ...
        <Trigger
          ...
          className={
            asChild
              ? undefined
              : cn(
                  "relative z-10 grid place-items-center rounded-full text-text/60 transition-colors hover:text-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
                  SURFACE,
                  s.trigger,
                )
          }
