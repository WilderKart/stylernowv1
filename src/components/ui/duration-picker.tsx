...
function DurationPicker({
    ...
    useEffect(() => {
        ...
        // Sincroniza el texto mostrado con el valor controlado externo — patrón
        // estándar para inputs de texto formateado sobre un valor numérico
        // controlado (no hay forma de derivarlo puramente durante el render
    ...
    return (
        <motion.div
            ...
            className={cn('flex flex-row items-center justify-center text-text', disabled && 'opacity-50', className)}
            {...props}
        >
