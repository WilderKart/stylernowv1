...
- **Finalidad específica.** Cada dato capturado tiene una finalidad declarada (ej. teléfono → notificaciones de Reserva; fecha de nacimiento → beneficio de cumpleaños de `03-Business-Rules/04_Lealtad.md`) — no se capturan datos "por si acaso".
